...
~Not sure how I'd word it, but the "Test your skills" at the bottom of the MDN tutorial requires information that is taught in the W3Schools lesson.  I'm not sure if the "Test your skills" is recommended, but either clarity on not doing that or some sort of reference to required information in the W3Schools lesson would help resolve some issues I had while progressing it.~
